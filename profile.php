        ...
        <div class="profile-left">
            ...
            <div class="rating">
                ...
                <svg width="13" height="23" viewBox="0 0 13 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.33429 14.2913L1.55658 8.94428L8.56476 7.42668L8.7801 7.38005L8.891 7.18966L12 1.85189V19.0489L5.73658 21.809L6.4589 14.6749L6.4811 14.4556L6.33429 14.2913Z" fill="#FFCC18" stroke="#1E201E"/>
                </svg>
            </div>
            <p>"I specialize in Plumbing and Electrical works. Available to work in Sundays too!"</p>
        </div>
        ...
        <div class="profile-right">
            ...
            <div class="star-rate-container">
                ...
                <form action="<?= ROOT_URL ?>profile-logic.php" method="POST">
                    <div class="star-rate">
                        <input type="radio" name="rating" id="star5" value="5" <?php if ($rating == 5) echo "checked" ?>>
                        <label for="star5">
                            <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 0.993445L16.1089 7.18966L16.2198 7.38005L16.4352 7.42668L23.4434 8.94428L18.6656 14.2913L18.5188 14.4556L18.541 14.6749L19.2634 21.809L12.7016 18.9175L12.5 18.8286L12.2984 18.9175L5.7366 21.809L6.45892 14.6749L6.48112 14.4556L6.33431 14.2913L1.5566 8.94428L8.56478 7.42668L8.78012 7.38005L8.89101 7.18966L12.5 0.993445Z" fill="#FFCC18" stroke="#1E201E"/>
                            </svg>
                        ...
                        <input type="radio" name="rating" id="star4" value="4" <?php if ($rating == 4) echo "checked" ?>>
                        <label for="star4">
                            <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 0.993445L16.1089 7.18966L16.2198 7.38005L16.4352 7.42668L23.4434 8.94428L18.6656 14.2913L18.5188 14.4556L18.541 14.6749L19.2634 21.809L12.7016 18.9175L12.5 18.8286L12.2984 18.9175L5.7366 21.809L6.45892 14.6749L6.48112 14.4556L6.33431 14.2913L1.5566 8.94428L8.56478 7.42668L8.78012 7.38005L8.89101 7.18966L12.5 0.993445Z" fill="#FFCC18" stroke="#1E201E"/>
                            </svg>
                        ...
                        <input type="radio" name="rating" id="star3" value="3" <?php if ($rating == 3) echo "checked" ?>>
                        <label for="star3">
                            <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 0.993445L16.1089 7.18966L16.2198 7.38005L16.4352 7.42668L23.4434 8.94428L18.6656 14.2913L18.5188 14.4556L18.541 14.6749L19.2634 21.809L12.7016 18.9175L12.5 18.8286L12.2984 18.9175L5.7366 21.809L6.45892 14.6749L6.48112 14.4556L6.33431 14.2913L1.5566 8.94428L8.56478 7.42668L8.78012 7.38005L8.89101 7.18966L12.5 0.993445Z" fill="#FFCC18" stroke="#1E201E"/>
                            </svg>
                        ...
                        <input type="radio" name="rating" id="star2" value="2" <?php if ($rating == 2) echo "checked" ?>>
                        <label for="star2">
                            <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 0.993445L16.1089 7.18966L16.2198 7.38005L16.4352 7.42668L23.4434 8.94428L18.6656 14.2913L18.5188 14.4556L18.541 14.6749L19.2634 21.809L12.7016 18.9175L12.5 18.8286L12.2984 18.9175L5.7366 21.809L6.45892 14.6749L6.48112 14.4556L6.33431 14.2913L1.5566 8.94428L8.56478 7.42668L8.78012 7.38005L8.89101 7.18966L12.5 0.993445Z" fill="#FFCC18" stroke="#1E201E"/>
                            </svg>
                        ...
                        <input type="radio" name="rating" id="star1" value="1" <?php if ($rating == 1) echo "checked" ?>>
                        <label for="star1">
                            <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 0.993445L16.1089 7.18966L16.2198 7.38005L16.4352 7.42668L23.4434 8.94428L18.6656 14.2913L18.5188 14.4556L18.541 14.6749L19.2634 21.809L12.7016 18.9175L12.5 18.8286L12.2984 18.9175L5.7366 21.809L6.45892 14.6749L6.48112 14.4556L6.33431 14.2913L1.5566 8.94428L8.56478 7.42668L8.78012 7.38005L8.89101 7.18966L12.5 0.993445Z" fill="#FFCC18" stroke="#1E201E"/>
                            </svg>
                        ...
                        <br>
                        <button type="submit" class="btn rating-btn" name="submit"><?php $rating > 0 ? print "Update" : print "Submit" ?></button>
                        <br>
